...
Already on the timeline, replies, and the profile header (after the display name). Tweets put it after the timestamp, or after the @handle when there is no time. Hover the flag for the country name. Regions such as "Europe & Central Asia" get a globe.
